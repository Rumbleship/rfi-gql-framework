...
const rumbleship_context_1 = require("./../server/rumbleship-context");
...
function createBaseResolver(baseName, objectTypeCls, connectionTypeCls, filterClsType, inputClsType, updateClsType, notificationClsType, defaultScope) {
    ...
    let BaseResolver = class BaseResolver extends GQLBaseResolver {
        ...
        async onChange(ctx, rawPayload) {
            return ctx.beeline.bindFunctionToTrace(() => helper_1.createPayloadUsingStr(rawPayload, this, notificationClsType))();
        }
    };
    __decorate([
        o11y_1.AddToTrace(),
    ...
    __decorate([
        ...
        type_graphql_1.Subscription(type => notificationClsType, {
            ...
            topics: `${node_notification_1.NODE_CHANGE_NOTIFICATION}_${capitalizedName}`,
            nullable: true
        }),
...
function createReadOnlyBaseResolver(baseName, objectTypeCls, connectionTypeCls, filterClsType, notificationClsType, defaultScope) {
    ...
    let BaseResolver = class BaseResolver extends GQLBaseResolver {
        ...
        async onChange(rawPayload) {
            return this.ctx.beeline.bindFunctionToTrace(() => helper_1.createPayloadUsingStr(rawPayload, this, notificationClsType))();
        }
    };
    __decorate([
        o11y_1.AddToTrace(),
