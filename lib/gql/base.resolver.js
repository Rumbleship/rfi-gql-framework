...
const gql_pubsub_sequelize_engine_1 = require("../db/gql_pubsub_sequelize_engine");
...
function createBaseResolver(baseName, objectTypeCls, connectionTypeCls, filterClsType, inputClsType, updateClsType, notificationClsType) {
    ...
    let BaseResolver = class BaseResolver extends GQLBaseResolver {
        ...
        async onChange(payload) {
            ...
            const gqlNodeNotification = new node_notification_1.GqlNodeNotification(payload.notificationOf, node);
    ...
    __decorate([
        type_graphql_1.Subscription(type => notificationClsType, {
            ...
            topics: () => `${gql_pubsub_sequelize_engine_1.NODE_CHANGE_NOTIFICATION}_${objectTypeCls.name}Model`,
            nullable: true
        }),
