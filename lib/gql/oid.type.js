...
class Oid {
    ...
    unwrap() {
        ...
        if (this.oid[0] === '~') {
            const plain = base64_1.fromBase64(this.oid.substring(1));
            try {
            ...
            if (matches && matches.length === 3) {
                ...
                const decoder = scope && Object.keys(Oid.alphaSalts).includes(scope)
                    ? new hashids_1.default(Reflect.get(Oid.alphaSalts, scope), Oid.HASHID_MIN_LEN, Oid.ALPHABET)
                    : Oid.hashids;
