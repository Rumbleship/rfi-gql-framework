...
let NodeResolver = class NodeResolver {
    ...
    publishLastKnownState(oid, pubSub, ctx) {
    ...
    async onChange(payload) {
        ...
        const oid = index_1.Oid.create(gqlModelName, modelId);
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [index_1.Oid,
        type_graphql_1.PubSubEngine, Object]),
