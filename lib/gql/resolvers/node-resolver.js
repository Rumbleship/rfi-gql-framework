...
const version_scoped_topic = topic_name_1.triggerName();
class Empty {
}
...
__decorate([
    ...
    __metadata("design:type", String)
], ClassGqlNodeNotification.prototype, "marshalledTrace", void 0);
__decorate([
...
let NodeResolver = class NodeResolver {
    ...
    async publishLastKnownState(oidString, pubSub, ctx) {
        const oid = new oid_1.Oid(oidString);
        const { scope } = oid.unwrap();
        if (scope in this.nodeServices) {
    ...
    async onChange(rawPayload, args, ctx) {
        ...
        if (scope in this.nodeServices) {
            ...
            return create_node_notification_1.createNodeNotification(rawPayload, service, ClassGqlNodeNotification, args === null || args === void 0 ? void 0 : args.watch_list);
        }
        throw Error('Invalid OID. Scope: ' + scope);
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, rumbleship_context_1.RumbleshipContext]),
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, type_graphql_1.PubSubEngine,
        rumbleship_context_1.RumbleshipContext]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(2, type_graphql_1.Ctx()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, rumbleship_context_1.RumbleshipContext]),
    __metadata("design:returntype", Promise)
