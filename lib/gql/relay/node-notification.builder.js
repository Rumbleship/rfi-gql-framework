...
function GqlNodeNotification(clsNotification) {
    ...
    __decorate([
        ...
        type_graphql_1.Field({
            description: 'Requesting this on a QSO will allow the trace to propagate from model-change publisher through QSO infra. Your responder will be executed within the trace context of the initial publish. This value is _explicitly deleted_ from the data that is passed into your subscription resolver.'
        }),
        __metadata("design:type", String)
    ], GqlNodeNotificationClass.prototype, "marshalledTrace", void 0);
