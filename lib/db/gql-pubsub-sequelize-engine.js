...
exports.pubSubFrom = exports.publishCurrentState = exports.linkSequelizeToPubSubEngine = void 0;
...
function gqlCreateHook(pubSub, instance, deltas, options) {
    pubSub.publishPayload(node_notification_1.NotificationOf.CREATED, instance, deltas);
}
function gqlUpdateHook(pubSub, instance, deltas, options) {
    pubSub.publishPayload(node_notification_1.NotificationOf.UPDATED, instance, deltas);
}
