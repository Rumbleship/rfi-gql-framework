...
class GqlSingleTableInheritanceFactory {
    constructor(nodeService, oidScope, discriminatorKey, concreteClassMap) {
...
function modelToClass(nodeService, to, from, oidScope) {
    ...
    const oid = index_1.Oid.create(oidScope ? oidScope : obj.constructor['name'], modelAsPlain.uuid ? modelAsPlain.uuid : modelAsPlain.id);
    obj.id = oid;
