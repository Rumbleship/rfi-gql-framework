...
const create_order_clause_1 = require("./create_order_clause");
...
let SequelizeBaseService = SequelizeBaseService_1 = class SequelizeBaseService {
    ...
    addAuthorizationToWhere(authorizableClasses, findOptions, nodeServiceOptions = {}, forCountQuery = false) {
        ...
        for (const authProtos of protypesForClasses) {
            whereAuthClause = {
                ...whereAuthClause,
                ...create_auth_where_clause_1.createAuthWhereClause(this.permissions, this.ctx.authorizer, (_a = nodeServiceOptions === null || nodeServiceOptions === void 0 ? void 0 : nodeServiceOptions.action) !== null && _a !== void 0 ? _a : acl_1.Actions.QUERY, authProtos)
            };
            ...
            for (const authEntry of authThroughEntries) {
                includedWhereAuthClause = {
                    ...includedWhereAuthClause,
                    ...create_auth_where_clause_1.createAuthWhereClause(this.permissions, this.ctx.authorizer, (_b = nodeServiceOptions === null || nodeServiceOptions === void 0 ? void 0 : nodeServiceOptions.action) !== null && _b !== void 0 ? _b : acl_1.Actions.QUERY, authEntry.targetClass().prototype, authEntry.associationName)
                };
    ...
    async addAuthorizationFiltersAndWrapWithTransaction(options, theFunctionToWrap) {
        ...
        create_auth_where_clause_1.setAuthorizeContext(opts.transaction, {});
            ...
            if (!SequelizeBaseService_1.hooksMap.has(modelClass)) {
                ...
                modelClass.addHook('beforeFind', (findOptions) => {
                    ...
                    if (!authorizeContext) {
                        ...
                        if (transaction && create_auth_where_clause_1.getAuthorizeContext(transaction)) {
                            return;
                        }
    ...
    async getAll(filterBy, options) {
        ...
        const orderClause = create_order_clause_1.createOrderClause(order_by);
    ...
    async update(updateInput, options, target) {
        ...
        try {
            ...
            const findOptions = create_auth_where_clause_1.setAuthorizeContext({ ...sequelizeOptions, transaction: updateTransaction }, { authApplied: true });
...
SequelizeBaseService = SequelizeBaseService_1 = __decorate([
    typedi_1.Service(),
    __metadata("design:paramtypes", [Object, Object, Object, Object, index_2.RumbleshipContext, Object])
