...
let SequelizeBaseService = SequelizeBaseService_1 = class SequelizeBaseService {
     ...
     */
    addAuthorizationFilters(findOptions, nodeServiceOptions, authorizableClass = this.relayClass) {
        var _a, _b;
        const authorizeContext = (_a = create_auth_where_clause_1.getAuthorizeContext(findOptions), (_a !== null && _a !== void 0 ? _a : {
            nodeServiceOptions,
            service: this,
            authorizableClass
        }));
        if (authorizeContext.authApplied || ((_b = nodeServiceOptions) === null || _b === void 0 ? void 0 : _b.skipAuthorizationCheck) ||
        ...
        findOptions = this.addAuthorizationToWhere(authorizableClass, findOptions, authorizeContext.nodeServiceOptions);
     ...
     */
    addAuthorizationToWhere(authorizableClass, findOptions, nodeServiceOptions) {
        var _a, _b, _c, _d, _e;
        if (!((_a = nodeServiceOptions) === null || _a === void 0 ? void 0 : _a.skipAuthorizationCheck)) {
            const whereAuthClause = create_auth_where_clause_1.createAuthWhereClause(this.permissions, this.ctx.authorizer, (_c = (_b = nodeServiceOptions) === null || _b === void 0 ? void 0 : _b.action, (_c !== null && _c !== void 0 ? _c : acl_1.Actions.QUERY)), authorizableClass.prototype);
            // any associated objects that must be scanned?
            const authThroughEntries = create_auth_where_clause_1.getAuthorizeThroughEntries(authorizableClass.prototype);
            const eagerLoads = [];
    ...
    async update(updateInput, options, target) {
        ...
        try {
            ...
            modelInstance.update(updateInput, {
                ...sequelizeOptions,
