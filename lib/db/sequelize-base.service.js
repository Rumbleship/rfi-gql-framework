...
const with_span_decorator_1 = require("./with-span.decorator");
...
let SequelizeBaseService = SequelizeBaseService_1 = class SequelizeBaseService {
    constructor(relayClass, edgeClass, connectionClass, model, ctx, options) {
        ...
        this.transactionSpansMap = new Map();
    ...
    async newTransaction(params) {
        ...
        this.transactionSpansMap.set(txn.id, span);
        this.ctx.logger.addMetadata({
    ...
    async endTransaction(transaction, action) {
        this.ctx.rfiBeeline.finishSpan(this.transactionSpansMap.get(transaction.id));
        switch (action) {
            case 'commit':
...
__decorate([
    with_span_decorator_1.WithSpan({ ...defaultSpanData }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SequelizeBaseService.prototype, "can", null);
__decorate([
    with_span_decorator_1.WithSpan({ ...defaultSpanData }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, Object]),
    __metadata("design:returntype", void 0)
], SequelizeBaseService.prototype, "addAuthorizationFilters", null);
__decorate([
    with_span_decorator_1.WithSpan({ ...defaultSpanData }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Array, Object, Object]),
    __metadata("design:returntype", Object)
], SequelizeBaseService.prototype, "addAuthorizationToWhere", null);
__decorate([
    with_span_decorator_1.WithSpan({ ...defaultSpanData }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Object)
], SequelizeBaseService.prototype, "gqlFromDbModel", null);
__decorate([
    with_span_decorator_1.WithSpan({ ...defaultSpanData }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", typeof (_a = typeof V !== "undefined" && V) === "function" ? _a : Object)
], SequelizeBaseService.prototype, "getServiceFor", null);
__decorate([
    with_span_decorator_1.WithSpan({ ...defaultSpanData }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [sequelize_typescript_1.Model]),
    __metadata("design:returntype", Object)
], SequelizeBaseService.prototype, "getServiceForDbModel", null);
__decorate([
    with_span_decorator_1.WithSpan({ ...defaultSpanData }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], SequelizeBaseService.prototype, "convertServiceOptionsToSequelizeOptions", null);
__decorate([
    with_span_decorator_1.WithSpan({ ...defaultSpanData }),
    __metadata("design:type", Function),
...
__decorate([
    with_span_decorator_1.WithSpan({ ...defaultSpanData }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [oid_1.Oid]),
    __metadata("design:returntype", Promise)
], SequelizeBaseService.prototype, "publishLastKnownState", null);
__decorate([
    with_span_decorator_1.WithSpan({ ...defaultSpanData }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object]),
