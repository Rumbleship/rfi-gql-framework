    ...
    async getAll(filterBy, options) {
        ...
        */
        ...
        if (id_attribute) {
            ...
            if (((_b = (_a = id_attribute) === null || _a === void 0 ? void 0 : _a.type) === null || _b === void 0 ? void 0 : _b.key) === 'INTEGER') {
                orderClause = [['id', 'DESC']];
            }
            else {
        ...
        const sequelizeOptions = (_c = this.convertServiceOptionsToSequelizeOptions(options), (_c !== null && _c !== void 0 ? _c : {}));
        const findOptions = {
            where: whereClause,
