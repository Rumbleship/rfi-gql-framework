...
function getAuthorizeThroughEntries(target) {
    return Reflect.getMetadata(exports.AUTHORIZE_THROUGH_ENTRIES, target);
}
...
function createAuthWhereClause(permissions, authorizer, targetClass, associationName) {
...
function getAuthorizeContext(target) {
    return Reflect.getMetadata(exports.AuthorizeContextKey, target);
}
