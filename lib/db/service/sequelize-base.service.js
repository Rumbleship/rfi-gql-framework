...
let SequelizeBaseService = SequelizeBaseService_1 = class SequelizeBaseService {
    ...
    addAuthorizationToWhere(authorizableClasses, findOptions, nodeServiceOptions = {}, forCountQuery = false) {
        ...
        for (const authProtos of protypesForClasses) {
            whereAuthClause = {
                ...whereAuthClause,
                ...transformers_1.createAuthWhereClause(this.permissions, this.ctx.authorizer, (_c = (_b = nodeServiceOptions) === null || _b === void 0 ? void 0 : _b.action, (_c !== null && _c !== void 0 ? _c : acl_1.Actions.QUERY)), authProtos)
            };
            ...
            for (const authEntry of authThroughEntries) {
                includedWhereAuthClause = {
                    ...includedWhereAuthClause,
                    ...transformers_1.createAuthWhereClause(this.permissions, this.ctx.authorizer, (_e = (_d = nodeServiceOptions) === null || _d === void 0 ? void 0 : _d.action, (_e !== null && _e !== void 0 ? _e : acl_1.Actions.QUERY)), authEntry.targetClass().prototype, authEntry.associationName)
                };
    ...
    async getAll(filterBy, options) {
        ...
        */
        ...
        const id_attribute = this.model.rawAttributes['id']; // sequelize typings are not correct
        const orderClause = id_attribute ? [['id', 'DESC']] : undefined;
    ...
    async publishLastKnownState(oid) {
        ...
        app_1.publishCurrentState(instance);
    }
    /**
    ...
    /* <TAssocApi extends Node,
      ...
      TAssocModel
      > */
    async getAssociatedMany(source, assoc_key, filterBy, assocApiClass, assocEdgeClass, assocConnectionClass, options, order) {
        /* for (const [k, v] of Object.entries(filterBy)) {
          this.ctx.rfiBeeline.addContext({
            [`framework.db.service.filter.${k}`]: v
          });
...
__decorate([
    o11y_1.AddToTrace(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, Object, Object, Object, Object, Object, Object]),
    __metadata("design:returntype", Promise)
