...
let SequelizeBaseService = SequelizeBaseService_1 = class SequelizeBaseService {
    ...
    can(params) {
        ...
        const can = ((_a = params === null || params === void 0 ? void 0 : params.options) === null || _a === void 0 ? void 0 : _a.transaction) || ((_b = params === null || params === void 0 ? void 0 : params.options) === null || _b === void 0 ? void 0 : _b.skipAuthorizationCheck) ||
            this.ctx.authorizer.can(params.action, params.authorizable, this.permissions, (_c = params.treatAsAuthorizerMap) !== null && _c !== void 0 ? _c : transformers_1.getAuthorizerTreatAsNoDefault(params.authorizable));
    ...
    async getAll(filterBy, options) {
        var _a;
        filterBy = gql_1.transposeDeprecatedValues(filterBy);
    ...
    async create(createInput, options) {
        createInput = gql_1.transposeDeprecatedValues(createInput);
        if (this.can({
    ...
    async update(updateInput, options, target) {
        ...
        updateInput = gql_1.transposeDeprecatedValues(updateInput);
