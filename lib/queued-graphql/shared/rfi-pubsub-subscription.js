...
class RfiPubSubSubscription {
    ...
    dispatch(ctx, message, handler, source_name = this.constructor.name) {
        ...
        if (payload) {
            ...
            return ctx.beeline
                .bindFunctionToTrace(() => ctx.beeline
    ...
    async listen(handler, source_name = this.constructor.name, trace) {
        ...
        try {
            ...
            for await (const [message] of this.messages) {
                ...
                pending_message === null || pending_message === void 0 ? void 0 : pending_message.ack();
            }
        }
        catch (error) {
            ...
            if (pending_message) {
                pending_message === null || pending_message === void 0 ? void 0 : pending_message.nack();
