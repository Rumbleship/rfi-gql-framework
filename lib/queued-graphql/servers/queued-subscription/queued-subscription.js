...
const node_id_from_execution_result_1 = require("src/queued-graphql/helpers/node-id-from-execution-result");
class QueuedSubscription {
    ...
    async publishResponse(ctx, response) {
         ...
         */
        const orderingKey = (_d = (_c = node_id_from_execution_result_1.rootNodeFrom(response)) !== null && _c !== void 0 ? _c : this.id.toString()) !== null && _d !== void 0 ? _d : 'qsr';
        const message = {
