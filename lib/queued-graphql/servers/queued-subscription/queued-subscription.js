...
const node_id_from_execution_result_1 = require("../../../queued-graphql/helpers/node-id-from-execution-result");
class QueuedSubscription {
    ...
    async publishResponse(ctx, response) {
        var _a, _b, _c, _d;
        const orderingKey = (_b = (_a = node_id_from_execution_result_1.rootNodeFrom(response)) !== null && _a !== void 0 ? _a : this.id.toString()) !== null && _b !== void 0 ? _b : 'qsr';
        ...
        const subscription_name = (_c = this.subscription_name) !== null && _c !== void 0 ? _c : '';
        const message_body = {
            owner_id: (_d = this.owner_id) !== null && _d !== void 0 ? _d : '',
            subscription_name,
