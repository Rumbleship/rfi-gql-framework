...
exports.QueuedCacheScopeAndDb = exports.QsrCacheOidScope = exports.saveCache = exports.loadCache = exports.QsrLocalCacheModel = exports.QueuedSubscriptionCache = exports.PersistableQueuedSubscription = void 0;
    ...
    if (sequelize) {
        ...
        if (!qsrCache) {
            ...
            if (version !== qsrCache.cache.version) {
                qsrCache = await qsrCache.update({ cache: new QueuedSubscriptionCache(version) }, { transaction: opts === null || opts === void 0 ? void 0 : opts.transaction });
            }
        }
...
exports.QueuedCacheScopeAndDb = { scope: exports.QsrCacheOidScope, QsrLocalCacheModel };
