...
class QueuedGqlRequestClientSingleInstanceResponder {
    constructor(config) {
        ...
        this._pubsub = new pubsub_1.PubSub(pubsub_auth_project_1.forcePublicProjectPubsub(config.Gcp.Auth));
...
__decorate([
    ...
    __metadata("design:paramtypes", [rumbleship_context_1.RumbleshipContext, Object, Function]),
    __metadata("design:returntype", Promise)
], QueuedGqlRequestClientSingleInstanceResponder.prototype, "makeRequest", null);
__decorate([
    o11y_1.AddToTrace(),
    __metadata("design:type", Function),
