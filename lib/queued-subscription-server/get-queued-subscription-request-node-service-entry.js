...
const webhook_service_1 = require("./queued_subscription_request/db/webhook.service");
/***
...
function getWebhookNodeServiceEntry(context) {
    return {
        [inititialize_queued_subscription_relay_1.getWebhookScopeName()]: new webhook_service_1.WebhookServiceSequelize(context)
    };
}
