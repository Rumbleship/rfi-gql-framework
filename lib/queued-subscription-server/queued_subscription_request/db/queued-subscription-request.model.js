...
const QueuedSubscriptionRequestValidator = class extends queued_subscription_request_relay_1.buildQueuedSubscriptionRequestBaseAttribs(attrib_enum_1.AttribType.ValidateOnly) {
};
let QueuedSubscriptionRequestModel = class QueuedSubscriptionRequestModel extends sequelize_typescript_1.Model {
    static afterValidateHook(instance, options) {
        validate_from_exemplar_1.validateFromExemplar(instance, QueuedSubscriptionRequestValidator);
    }
};
__decorate([
...
], QueuedSubscriptionRequestModel.prototype, "owner_id", void 0);
__decorate([
    sequelize_typescript_1.Column,
    __metadata("design:type", String)
...
__decorate([
    sequelize_typescript_1.Column,
    __metadata("design:type", String)
], QueuedSubscriptionRequestModel.prototype, "subscription_name", void 0);
__decorate([
...
__decorate([
    sequelize_typescript_1.ForeignKey(() => webhook_model_1.WebhookModel),
    sequelize_typescript_1.Column(sequelize_typescript_1.DataType.INTEGER),
    __metadata("design:type", Number)
], QueuedSubscriptionRequestModel.prototype, "webhook_id", void 0);
__decorate([
    sequelize_typescript_1.BelongsTo(() => webhook_model_1.WebhookModel),
    __metadata("design:type", webhook_model_1.WebhookModel)
], QueuedSubscriptionRequestModel.prototype, "webhook", void 0);
__decorate([
...
//# sourceMappingURL=queued-subscription-request.model.js.map