...
exports.QueuedSubscriptionRequestResolver = void 0;
const type_graphql_1 = require("type-graphql");
const __1 = require("../../../");
const typedi_1 = require("typedi");
const queued_subscription_request_relay_1 = require("./queued_subscription_request.relay");
...
const payload_on_watch_list_1 = require("../../payload_on_watch_list");
const rumbleship_subscription_options_1 = require("../../rumbleship_subscription_options");
...
let QueuedSubscriptionRequestResolver = class QueuedSubscriptionRequestResolver extends __1.GQLBaseResolver {
    constructor(service) {
        super(service);
    ...
    async onChange(rawPayload, args) {
        return __1.createNodeNotification(rawPayload, this, queued_subscription_request_relay_1.QueuedSubscriptionRequestNotification);
    }
};
__decorate([
    o11y_1.AddToTrace(),
    type_graphql_1.Authorized(permissions_1.ResolverPermissions.QueuedSubscriptionRequest.default),
    type_graphql_1.Query(type => queued_subscription_request_relay_1.QueuedSubscriptionRequest, { name: `${baseName}s` }),
...
__decorate([
    o11y_1.AddToTrace(),
    type_graphql_1.Authorized(permissions_1.ResolverPermissions.QueuedSubscriptionRequest.default),
    rumbleship_subscription_options_1.RumbleshipSubscription(type => queued_subscription_request_relay_1.QueuedSubscriptionRequestNotification, {
        name: `on${capitalizedName}Change`,
        topics: [`${__1.NODE_CHANGE_NOTIFICATION}_${inititialize_queued_subscription_relay_1.getQueuedSubscriptionRequestScopeName()}`],
        filter: async ({ payload, args, context }) => {
            ...
            if (args) {
                ...
                if (!inititialize_queued_subscription_relay_1.isQeuedSubscriptionOidForThisService(oid)) {
                    return false;
                }
                const { watch_list, ...mutated_filter } = args;
                filter = mutated_filter !== null && mutated_filter !== void 0 ? mutated_filter : {};
            }
            const queuedSubscriptionRequestService = context.container.get(`${inititialize_queued_subscription_relay_1.getQueuedSubscriptionRequestScopeName()}Service`);
...
exports.QueuedSubscriptionRequestResolver = QueuedSubscriptionRequestResolver;
//# sourceMappingURL=queued_subscription_request.resolver.js.map