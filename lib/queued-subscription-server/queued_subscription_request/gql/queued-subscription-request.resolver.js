...
function buildQueuedSubscriptionRequestResolver() {
    ...
    const baseName = prefix
        ? `${prefix}${inititialize_queued_subscription_relay_1.getQueuedSubscriptionRequestScopeName()}`
        : lodash_1.lowerFirst(inititialize_queued_subscription_relay_1.getQueuedSubscriptionRequestScopeName());
