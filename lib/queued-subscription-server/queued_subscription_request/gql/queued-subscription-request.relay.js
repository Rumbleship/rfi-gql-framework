...
function buildQueuedSubscriptionRequestBaseAttribs(attribType) {
    ...
    __decorate([
        ...
        acl_1.AuthorizerTreatAs([acl_1.Resource.User, acl_1.Resource.Division]),
        type_graphql_1.Field(type => type_graphql_1.ID, { nullable: true }),
        __metadata("design:type", String)
    ], BaseQueuedSubscriptionRequestAttribs.prototype, "owner_id", void 0);
    __decorate([
        watchable_1.Watchable,
    ...
    __decorate([
        ...
        type_graphql_1.Field({ nullable: !base_attribs_builder_1.isInputOrObject(attribType) }),
        __metadata("design:type", String)
    ], BaseQueuedSubscriptionRequestAttribs.prototype, "subscription_name", void 0);
    __decorate([
        watchable_1.Watchable,
...
__decorate([
    type_graphql_1.Field({ nullable: true }),
    __metadata("design:type", String)
], WebhookSubscription.prototype, "subscription_name", void 0);
__decorate([
...
let QueuedSubscriptionRequest = class QueuedSubscriptionRequest extends with_timestamps_mixin_1.withTimeStamps(attrib_enum_1.AttribType.Obj, buildQueuedSubscriptionRequestBaseAttribs(attrib_enum_1.AttribType.Obj)) {
};
