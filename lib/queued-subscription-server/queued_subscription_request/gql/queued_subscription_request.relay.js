 ...
 */
let QueuedSubscriptionRequestFilterForSubscriptions = class QueuedSubscriptionRequestFilterForSubscriptions extends with_subscription_filter_mixin_1.withSubscriptionFilter(with_timestamps_filter_mixin_1.withTimeStampsFilter(ConcreteQueuedSubscriptionRequestFilter), `${inititialize_queued_subscription_relay_1.getRelayPrefix()}QueuedSubscriptionRequestWatchList`) {
};
