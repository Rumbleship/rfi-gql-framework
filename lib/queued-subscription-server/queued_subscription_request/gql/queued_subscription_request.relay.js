...
*/
const QueuedSubscriptionRequestWatchList = buildSubscriptionWatchList(new ConcreteQueuedSubscriptionRequestFilter(), [], []);
...
function buildSubscriptionWatchList(from, exclude, add) {
    const watchList = {};
