...
exports.buildWebhookResolver = exports.RemoveWebhookInput = exports.RemoveSubscriptionPayload = exports.RemoveSubscriptionInput = exports.AddSubscriptionPayload = exports.AddSubscriptionInput = exports.RemoveWebhookPayload = exports.AddWebhookPayload = void 0;
...
], AddSubscriptionInput.prototype, "webHookId", void 0);
__decorate([
...
__decorate([
    type_graphql_1.Field({ nullable: true }),
    __metadata("design:type", String)
], AddSubscriptionInput.prototype, "client_request_uuid", void 0);
__decorate([
...
__decorate([
    type_graphql_1.Field(type => queued_subscription_request_relay_1.WebhookSubscription),
    __metadata("design:type", queued_subscription_request_relay_1.WebhookSubscription)
...
function buildWebhookResolver(config) {
    const baseName = `${inititialize_queued_subscription_relay_1.getRelayPrefixLowerCase()}${inititialize_queued_subscription_relay_1.getWebhookScopeName()}`;
    ...
    let WebhookResolver = class WebhookResolver extends base_resolver_1.GQLBaseResolver {
        ...
        async addSubscription(webhookId, input) {
            return relay_mutation_1.setClientMutationIdOnPayload(input, async () => {
                const addSubscriptionPayload = new AddSubscriptionPayload();
                addSubscriptionPayload.webhookSubscription = await this.service.addSubscription(webhookId, input, {});
    ...
    __decorate([
        ...
        type_graphql_1.Query(type => webhook_relay_1.Webhook, { name: `${baseName}s` }),
    ...
    __decorate([
        o11y_1.AddToTrace(),
        type_graphql_1.Authorized(acl_1.Scopes.SYSADMIN),
        type_graphql_1.Mutation(type => webhook_relay_1.Webhook, { name: `update${capitalizedName}` }),
        __param(0, type_graphql_1.Arg('input', type => webhook_relay_1.WebhookUpdate)),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [webhook_relay_1.WebhookUpdate]),
        __metadata("design:returntype", Promise)
    ], WebhookResolver.prototype, "update", null);
    __decorate([
        o11y_1.AddToTrace(),
        type_graphql_1.Authorized(permissions_1.ResolverPermissions.Webhook.default),
        type_graphql_1.Mutation(type => AddWebhookPayload, { name: `add${capitalizedName}` }),
        __param(0, type_graphql_1.Arg('input', type => webhook_relay_1.WebhookInput)),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [webhook_relay_1.WebhookInput]),
        __metadata("design:returntype", Promise)
    ], WebhookResolver.prototype, "addWebhook", null);
    __decorate([
        o11y_1.AddToTrace(),
        type_graphql_1.Authorized(permissions_1.ResolverPermissions.Webhook.default),
        type_graphql_1.Mutation(type => RemoveWebhookPayload, { name: `remove${capitalizedName}` }),
    ...
    __decorate([
        o11y_1.AddToTrace(),
        type_graphql_1.Authorized(permissions_1.ResolverPermissions.Webhook.default),
        type_graphql_1.Mutation(type => AddSubscriptionPayload, { name: `addSubscription${capitalizedName}` }),
        __param(0, type_graphql_1.Arg('webhookId', type => type_graphql_1.ID)),
        __param(1, type_graphql_1.Arg('input', type => AddSubscriptionInput)),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [String, AddSubscriptionInput]),
        __metadata("design:returntype", Promise)
    ...
    __decorate([
        o11y_1.AddToTrace(),
        type_graphql_1.Authorized(permissions_1.ResolverPermissions.Webhook.default),
        type_graphql_1.FieldResolver(type => queued_subscription_request_relay_1.QueuedSubscriptionRequestConnection),
        __param(0, type_graphql_1.Ctx()),
        __param(1, type_graphql_1.Root()),
        __param(2, type_graphql_1.Args(type => queued_subscription_request_relay_1.QueuedSubscriptionRequestFilter)),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [rumbleship_context_1.RumbleshipContext,
            webhook_relay_1.Webhook,
            queued_subscription_request_relay_1.QueuedSubscriptionRequestFilter]),
        __metadata("design:returntype", Promise)
