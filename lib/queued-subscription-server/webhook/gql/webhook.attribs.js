...
function buildWebhookBaseAttribs(attribType) {
    ...
    __decorate([
        ...
        type_graphql_1.Field(type => type_graphql_1.ID, { description: 'Rumbleship provided owner_id/divsion_id', nullable: true }),
        __metadata("design:type", String)
    ], BaseWebhookAttribs.prototype, "owner_id", void 0);
    __decorate([
        watchable_1.Watchable,
    ...
    __decorate([
        ...
        type_graphql_1.Field({ nullable: true }),
        __metadata("design:type", String)
    ], BaseWebhookAttribs.prototype, "gclound_subscription", void 0);
    __decorate([
        class_validator_1.MaxLength(255),
        class_validator_1.MinLength(3),
        type_graphql_1.Field({ nullable: true }),
