...
function buildWebhookResolver(config) {
    ...
    const baseName = prefix ? `${prefix}${inititialize_queued_subscription_relay_1.getWebhookScopeName()}` : lodash_1.lowerFirst(inititialize_queued_subscription_relay_1.getWebhookScopeName());
