...
function publishCurrentState(instance) {
    ...
    if (pubSub) {
        pubSub.publishPayload(relay_1.NotificationOf.LAST_KNOWN_STATE, instance, []);
    }
}
...
function gqlCreateHook(pubSub, instance, deltas, options) {
    pubSub.publishPayload(relay_1.NotificationOf.CREATED, instance, deltas);
}
function gqlUpdateHook(pubSub, instance, deltas, options) {
    pubSub.publishPayload(relay_1.NotificationOf.UPDATED, instance, deltas);
}
