...
class RfiPubSub extends graphql_google_pubsub_1.GooglePubSub {
    ...
    triggerName(scope, prefix) {
        const elements = [gql_1.NODE_CHANGE_NOTIFICATION];
        if (prefix) {
        ...
        if (prefix) {
            return `${this.topicPrefix}_${gql_1.NODE_CHANGE_NOTIFICATION}_${scope}_${this.publisher_version}`;
        }
        else {
            return `${gql_1.NODE_CHANGE_NOTIFICATION}_${scope}_${this.publisher_version}`;
        }
    }
