...
exports.resetAllTables = exports.initSequelize = exports.getOidFor = exports.getScopeFor = exports.nullSequelizeInstance = exports.getSequelizeInstance = void 0;
...
async function initSequelize(cfg, loggingFun, dbModels, opt) {
    ...
    const force = (_b = opt === null || opt === void 0 ? void 0 : opt.force) !== null && _b !== void 0 ? _b : false;
    const dbSuffix = (_c = opt === null || opt === void 0 ? void 0 : opt.dbSuffix) !== null && _c !== void 0 ? _c : '';
