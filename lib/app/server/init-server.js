...
async function initServer(config, InjectedBeeline, injected_plugins, injected_models, injected_schema_options, injected_routes = [], formatError = defaultFormatError, onContainer, onInitialized = (_server) => Promise.resolve(), dbOptions) {
