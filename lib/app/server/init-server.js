...
async function initServer(config, InjectedBeeline, injected_hapi_plugins, injected_apollo_server_options = {}, injected_models, injected_schema_options, injected_routes = [], onContainer, onInitialized = (_server, _pubSub) => Promise.resolve(), dbOptions, injected_options_for_default_plugins) {
    ...
    const context_control_options = {
        ...
        attach_conditions: injected_options_for_default_plugins === null || injected_options_for_default_plugins === void 0 ? void 0 : injected_options_for_default_plugins.RumbleshipContextControl.attach_conditions,
        skip_conditions: injected_options_for_default_plugins === null || injected_options_for_default_plugins === void 0 ? void 0 : injected_options_for_default_plugins.RumbleshipContextControl.skip_conditions
    };
    ...
    const pubSub = new rfi_pub_sub_engine_1.RfiPubSub(config.Gcp.gaeVersion, config.PubSub, config.Gcp.Auth, InjectedBeeline);
        ...
        subscriptions: {
            onConnect: (connectionParams, webSocket, context) => {
                ...
                if (bearer_token) {
                    const authorizer = (() => {
                        try {
                            return new acl_1.Authorizer(bearer_token, config.AccessToken.secret);
                        }
                        catch (error) {
