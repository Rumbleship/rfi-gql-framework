...
const queued_subscription_request_models_1 = require("../../queued-subscription-server/_db/queued-subscription-request-models");
...
const queued_subscription_server_2 = require("../../queued-subscription-server");
async function initServer(config, InjectedBeeline, injected_hapi_plugins, injected_apollo_server_options = {}, injected_models, injected_schema_options, injected_routes = [], onContainer, onInitialized = (_server, _pubSub) => Promise.resolve(), dbOptions) {
    ...
    const webhookResolverClass = queued_subscription_server_2.buildWebhookResolver(config);
