...
const inititialize_queued_subscription_relay_1 = require("../../queued-subscription-server/inititialize-queued-subscription-relay");
const queued_subscription_server_1 = require("../../queued-subscription-server/queued-subscription-server");
const queued_subscription_request_resolver_1 = require("../../queued-subscription-server/queued_subscription_request/gql/queued-subscription-request.resolver");
const queued_subscription_request_models_1 = require("../../queued-subscription-server/queued_subscription_request/_db/queued-subscription-request-models");
const framework_node_services_1 = require("./framework-node-services");
const get_queued_subscription_request_node_service_entry_1 = require("../../queued-subscription-server/get-queued-subscription-request-node-service-entry");
const webhook_resolver_1 = require("../../queued-subscription-server/queued_subscription_request/gql/webhook.resolver");
async function initServer(config, InjectedBeeline, injected_hapi_plugins, injected_apollo_server_options = {}, injected_models, injected_schema_options, injected_routes = [], onContainer, onInitialized = (_server, _pubSub) => Promise.resolve(), dbOptions) {
    ...
    //
    inititialize_queued_subscription_relay_1.inititializeQueuedSubscriptionRelay(config);
    const qsrDbModelAndScope = queued_subscription_request_models_1.getQueuedSubscriptionRequestDbModelAndOidScope();
    injected_models = injected_models.concat(qsrDbModelAndScope);
    const qsrResolverClass = queued_subscription_request_resolver_1.buildQueuedSubscriptionRequestResolver();
    framework_node_services_1.addFrameworkServiceFactory(get_queued_subscription_request_node_service_entry_1.getQueuedSubscriptionRequestNodeServiceEntry);
    const webhookResolverClass = webhook_resolver_1.buildWebhookResolver(config);
    framework_node_services_1.addFrameworkServiceFactory(get_queued_subscription_request_node_service_entry_1.getWebhookNodeServiceEntry);
    ...
    const queuedSubscriptionServer = new queued_subscription_server_1.QueuedSubscriptionServer(exports.globalGraphQlSchema, config.Gcp);
