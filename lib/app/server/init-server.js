...
async function initServer(config, InjectedBeeline, injected_hapi_plugins, injected_apollo_server_options = {}, injected_models, injected_schema_options, injected_subscription_observers, injected_routes = [], onContainer, onInitialized = (_server, _pubSub) => Promise.resolve(), dbOptions) {
    ...
    init_queued_graphql_1.initQueuedGraphql(config, exports.globalGraphQlSchema, injected_subscription_observers);
