...
const subscription_trace_propagation_middleware_1 = require("./middleware/subscription-trace-propagation.middleware");
async function initServer(config, InjectedBeeline, injected_hapi_plugins, injected_apollo_server_options = {}, injected_models, injected_schema_options, injected_routes = [], onContainer, onInitialized = (_server, _pubSub) => Promise.resolve(), dbOptions) {
    ...
    const default_schema_options = {
        ...
        globalMiddlewares: [o11y_1.HoneycombMiddleware, middleware_1.LogErrorMiddlewareFn, subscription_trace_propagation_middleware_1.SubscriptionTracePropagation],
        resolvers: [],
        pubSub,
