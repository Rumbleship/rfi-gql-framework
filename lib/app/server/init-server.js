...
async function initServer(config, InjectedBeeline, injected_hapi_plugins, injected_apollo_plugins = [], injected_models, injected_schema_options, injected_routes = [], formatError = defaultFormatError, onContainer, onInitialized = (_server) => Promise.resolve(), dbOptions) {
    ...
    const default_schema_options = {
        ...
        globalMiddlewares: [o11y_1.HoneycombMiddleware, error_middleware_1.LogErrorMiddlewareFn],
        pubSub,
