...
async function initServer(config, InjectedBeeline, injected_hapi_plugins, injected_apollo_plugins = [], injected_models, injected_schema_options, injected_routes = [], onContainer, onInitialized = (_server) => Promise.resolve(), dbOptions) {
    ...
    const default_apollo_plugins = [plugins_1.logErrorsPlugin];
