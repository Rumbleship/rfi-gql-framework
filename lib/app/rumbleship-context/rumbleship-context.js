...
exports.getContextId = exports.setContextId = exports.RumbleshipContextIdKey = exports.withRumbleshipContext = exports.RumbleshipContext = void 0;
...
class RumbleshipContextOptionsWithDefaults {
    constructor(filename, options) {
        ...
        this._logger = (_b = options.logger) !== null && _b !== void 0 ? _b : spyglass_1.logging.getLogger({ config: this.config, filename });
        ...
        }, this.config.access_token.secret, { expiresIn: '5m' }), this.config.access_token.secret);
