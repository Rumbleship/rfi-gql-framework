...
exports.getAuthorizedUser = exports.setAuthorizedUser = exports.RumbleshipActingUserKey = exports.getContextId = exports.setContextId = exports.RumbleshipContextIdKey = exports.RumbleshipContext = void 0;
...
class RumbleshipContextOptionsWithDefaults {
    constructor(filename, options, config) {
        ...
        this._authorizer = (_c = options.authorizer) !== null && _c !== void 0 ? _c : acl_1.Auth0Authorizer.make(acl_1.Auth0Authorizer.createAuthHeader({
            user: config.ServiceUser.id,
            roles: {},
            scopes: [acl_1.Scopes.SYSADMIN]
        }, { expiresIn: '5m' }), true);
        this._authorizer.authenticate();
        this._container = (_d = options.container) !== null && _d !== void 0 ? _d : typedi_1.Container.of(this.id);
    }
    get authorizer() {
...
class RumbleshipContext {
    ...
    static withRumbleshipContext(filename, options, fn) {
        ...
        const ctx = typedi_1.Container.get('RumbleshipContext').make(filename, options);
...
exports.RumbleshipActingUserKey = '_@RumbleshipActingUserKey';
function setAuthorizedUser(target, authorizer) {
    Reflect.set(target, exports.RumbleshipActingUserKey, authorizer.getUser());
    return target;
}
exports.setAuthorizedUser = setAuthorizedUser;
function getAuthorizedUser(target) {
    return Reflect.get(target, exports.RumbleshipActingUserKey);
}
