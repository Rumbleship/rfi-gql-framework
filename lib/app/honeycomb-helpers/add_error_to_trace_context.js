...
function addErrorToTraceContext(ctx, error, alert = true) {
    let metadata = {
        'error.alert': alert,
    ...
    // sequelize...
    if (error instanceof sequelize_1.ValidationError /* sequelize error */) {
    ...
    if (error instanceof sequelize_1.OptimisticLockError) {
