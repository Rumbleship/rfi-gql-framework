...
exports.withRumbleshipContext = exports.RumbleshipContext = void 0;
    ...
    async release() {
        ...
        try {
            ...
            for (const query of queries) {
                const [db_variables] = ((_b = (await ((_a = db_1.getSequelizeInstance()) === null || _a === void 0 ? void 0 : _a.query(query)))) !== null && _b !== void 0 ? _b : [
                    []
                ]);
